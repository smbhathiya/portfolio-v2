        ...
        <section className="lg:py-16">
            <div className="grid grid-cols-1 sm:grid-cols-12">
                ...
                >
                    ...
                    <p className="text-[#ADB7BE] text-base sm:text-lg mb-6 lg:text-2xl lg:mb-8 font-bold">
                    ...
                    <div>
                        <Link
                            href="/#contact"
                            aria-label="Hire Me"
                            className="px-6 py-3 w-full sm:w-fit rounded-full mr-4 bg-btn_primary hover:bg-slate-600 duration-200 text-white font-bold"
                        >
                            Hire Me
                        </Link>
                        <Link
                            ...
                            className="px-1 py-1 w-full sm:w-fit rounded-full text-background font-bold mt-3"
                        >
