        ...
        <div>
            ...
            >
                <div className="overlay items-center justify-center absolute top-0 left-0 w-full h-full bg-[#181818] bg-opacity-0 hidden group-hover:flex group-hover:bg-opacity-80 transition-all duration-500">
                    <Link
                        href={gitUrl}
                        className="h-14 w-14 mr-2 border-2 relative rounded-full border-primary hover:bg-primary duration-200 group/link" target="_blank"
                    >
                    ...
                    <Link
                        href={previewUrl}
                        className="h-14 w-14 border-2 relative rounded-full border-primary text-primary hover:bg-primary duration-200 group/link" target="_blank"
                    >
